...
const icons={plus:'plus',settings:'settings',back:'arrow-left',chevron:'chevron-down',arrow:'arrow-up',stop:'square',shield:'shield-check',bolt:'zap',eye:'eye',close:'x',copy:'copy',edit:'pencil',search:'search',model:'bot','new-chat':'square-pen',hand:'hand',ask:'message-circle',plan:'list-checks',agent:'terminal',refresh:'refresh-cw',star:'star',trash:'trash-2'};
