...
- Investigate efficiently: use search_files to locate relevant code, then read_file only the needed ranges. Do not read dependency or generated directories (node_modules, dist, build, .venv, vendor, target, etc.).
