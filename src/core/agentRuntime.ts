import {normalizeProposal,bindStepReport} from "../plan/planContract";
import {Grant,currentScope,includesGrant,addGrant,CommandGrant} from "../plan/planAuthorization";
import {requestBinding,assertRequestBinding,requestModel} from "../providers/modelRequest";
import {verifyStep} from "../plan/planVerification";
import {PlanController,PlanState,StepReport,CommandEvidence} from "../plan/plan";
import {planFingerprint} from "../plan/planFingerprint";
...
import { toolPresentation } from "../tools/toolPresentation";

import { randomUUID } from 'node:crypto';
import * as path from 'node:path';


import { Action,ApprovalDenied,registry,toolDefinitions,validateAction } from "../tools/actions";
import type { Attachment } from "../context/attachments";
import { ContextEstimator,estimateTokens,fitContext } from "../context/context";
import { languageInstruction } from "../ui/conversation";
...
import { Mode,Permission,isMode,isPermission } from "../policy/policy";
import { projectRules } from "../context/projectContext";
import { systemPrompt } from "../ui/prompt";
import { ActivityData,AgentEvent,ChecklistItem,Request,Response,RunPhase,RunProgress } from "../ui/protocol";
import { ProviderManager } from "../providers/providerManager";
import { Message,compatibilityPayload } from "../providers/providers";
