import { FileGrant, CommandGrant } from "../plan/planAuthorization";
import type { GetDialogs } from "../ui/dialogs";
import type { Change } from "../tools/changes";
import * as path from "node:path";
import * as vscode from "vscode";
import { ApprovalDenied, validateAction } from "../tools/actions";
import { runCommandDetailed } from "../tools/command";
import { EditorContext, editorContextCoverage } from "../context/editorContext";
import { ExecutionError } from "./execution";
import { FileSnapshot, snapshotFile, verifySnapshot } from "../tools/files";
import { applyEdits } from "../tools/multiEdit";
import {
  Mode,
  Permission,
  canWrite,
...
import { InteractionReply, Response } from "../ui/protocol";
import { ProviderManager } from "../providers/providerManager";
import { Interactions } from "../ui/interaction";
import { contentVersion, executeReadTool } from "../tools/readTools";
import { ReviewService } from "./review";
import { Sandbox } from "../policy/sandbox";
import { SessionStore } from "../session/sessions";
